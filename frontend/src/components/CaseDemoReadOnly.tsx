...
const demoCaseData = {
  ...
  context: {
    ...
    situation: "Cliente corporativo de $2.5M anuales amenaza con cambiar proveedor si no obtiene descuento 25% en renovación. Usa ataques personales ('ustedes no entienden el mercado') y urgencia artificial ('decidimos esta semana').",
    challenge: "Equipo comercial reactivo quiere ceder para 'no perder el cliente'. Margen en riesgo. Cliente aprendió que escalar emocionalmente funciona.",
  },
  preparation: {
    objective_explicit: "Renovar contrato con máximo 10% descuento preservando margen.",
    objective_real: "Sostener autoridad profesional, que el cliente respete límites y entienda que presión emocional no extrae concesiones.",
    maan: "3 prospectos calificados en pipeline (uno en fase avanzada de $1.8M). No dependo de este cliente para sobrevivir.",
    counterpart_strength: "Cliente sabe que somos proveedor establecido (costo de cambio alto para ellos: migración técnica 6 meses, riesgo operativo). Su urgencia es REAL pero no nuestra.",
    breakpoint: "Descuento máximo 12%. Más allá erosiona margen y crea precedente peligroso para futuras renovaciones.",
    emotional_variable: "Frustración ante ataques personales. Riesgo de reaccionar defensivamente o ceder por agotamiento.",
    main_risk: "Concesiones impulsivas por presión emocional. Cliente replica táctica en próximas conversaciones.",
    key_signal: "Si cliente escala ataques personales después de exponer límites → señal de bluff. Si baja intensidad → interés real.",
  },
  analysis: {
  ...
  dashboards: {
    power: {
      your_maan: "3 prospectos calificados en pipeline, uno en fase avanzada ($1.8M). No dependo de este cliente para sobrevivir este trimestre.",
      your_maan_value: "$1.8M (prospecto avanzado)",
      your_urgency: "media",
      counterpart_maan_hypothesis: "Cambiar proveedor implica 6 meses de migración técnica + riesgo operativo. Su urgencia es mayor que la nuestra.",
      counterpart_urgency: "alta",
      relative_power_assessment: "favorable",
      power_explanation: "Cliente tiene mayor urgencia (riesgo operativo de cambio) y menor calidad de MAAN. Tu alternativa es viable. Poder relativo está de tu lado si sostenés límites.",
    },
    risks: {
      risks: [
        {
          risk_description: "Equipo cede por agotamiento emocional ante ataques personales repetidos",
          probability: "Alta",
          impact: "Crítico",
          alert_signal: "Frases como 'no vale la pena pelear por esto' o 'cerremos ya' en reunión interna",
          contingency_plan: "Pausar negociación 24h. Reunión interna para revisar walkaway point antes de continuar.",
        },
        {
          risk_description: "Cliente interpreta límite claro como 'postura de negociación' y escala presión",
          probability: "Media",
          impact: "Alto",
          alert_signal: "Cliente dice 'hablaré con tu jefe' o amenaza con escalar internamente",
          contingency_plan: "Mantener calma. Reconocer pedido ('entiendo que querés revisar con dirección') + reafirmar límite sin defensividad.",
        },
        {
          risk_description: "Concesión inicial dispara pedidos adicionales (descuento + condiciones de pago + servicios gratis)",
          probability: "Alta",
          impact: "Alto",
          alert_signal: "Cliente acepta descuento pero inmediatamente pide 'un tema más'",
          contingency_plan: "Anclar cada concesión a contrapartida: 'Si X, necesitamos Y'. No ceder unilateralmente.",
        },
      ],
    },
    concessions: {
      concessions: [
        { level: "Meta aspiracional", value: "Renovación sin descuento (precio lista)", condition: "Si cliente valora continuidad sin fricción", order: 1 },
        { level: "Concesión preparada", value: "Descuento 8% en contrato anual (vs semestral)", condition: "A cambio de compromiso 3 años", order: 2 },
        { level: "Concesión preparada", value: "Descuento 10% + valor agregado (capacitación equipo cliente)", condition: "Si cliente acepta caso de éxito público", order: 3 },
        { level: "Valor de reserva", value: "Descuento máximo 12%", condition: "Límite absoluto para preservar margen", order: 4 },
        { level: "Punto de ruptura", value: "No negociar más allá de 12%", condition: "Preparado para caminar si cliente insiste en 25%", order: 5 },
      ],
      total_flexibility: "Meta: 0% | Límite: 12% | Margen: 12 puntos para negociar",
    },
    summary: {
      power_position: "Favorable. Cliente tiene mayor urgencia y peor MAAN. Tu poder está en sostener límites sin reactividad emocional.",
      key_moves: [
      ...
      critical_signal: "Si cliente cambia tono después de límite claro → interés real. Si escala ataques → bluff, sostener.",
      red_line: "Descuento máximo 12%. Más allá → pausar y revisar walkaway internamente.",
      if_stalled: "Ofrecer pausa 48h para 'revisar con dirección'. Tiempo de-escala emoción y evidencia poder real.",
    },
  },
  execution: {
    explicit_objective_achieved: "Parcialmente. Renovamos con descuento 11% (dentro del margen), pero cliente pidió condiciones de pago extendidas durante la conversación.",
    real_objective_achieved: "Sí. Cliente respetó límite claro después de 2 intentos de escalar. Equipo sostuvo autoridad profesional sin reaccionar emocionalmente.",
    what_remains_open: "Condiciones de pago (60 vs 90 días). Cliente aceptó descuento pero 'necesita' más días para aprobación interna. Posible táctica.",
    where_power_shifted: "Cuando dijimos 'podemos pausar 48h para que revises internamente', cliente bajó inmediatamente la intensidad y aceptó límite de descuento. Confirmó que su urgencia era real.",
    decisive_objection: "'Ustedes no entienden que el mercado cambió, puedo conseguir lo mismo 30% más barato'. Respondimos con evidencia: 'Entendemos. ¿Cuál es tu alternativa concreta? Preparamos comparativa técnica'.",
    concession_that_changed_structure: "Descuento 11% + caso de éxito público cambió conversación de 'precio' a 'valor estratégico'. Cliente vio beneficio reputacional.",
    main_strategic_error: "No anticipé que cliente pediría condiciones de pago después de cerrar descuento. Debí anclar 'este descuento requiere pago 30 días'.",
    main_strategic_success: "Role playing pre-reunión funcionó perfectamente. Equipo no reaccionó ante ataques personales, mantuvo calma profesional.",
    decision_to_change: "Próxima negociación: anclar TODAS las variables desde el inicio (descuento + pago + servicios). No negociar una variable a la vez.",
  },
  debrief_comparative: {
    comparisons: [
      {
      ...
      {
        dimension: "Poder",
        prepared: "Cliente tiene mayor urgencia, nuestro MAAN es sólido (3 prospectos)",
        what_happened: "Confirmado. Cliente bajó intensidad cuando ofrecimos pausa 48h. Su urgencia era real.",
        gap: "Sin gap. Hipótesis de poder se confirmó en ejecución.",
      },
      {
        dimension: "Riesgo",
        prepared: "Equipo cede por agotamiento emocional ante ataques personales",
        what_happened: "Equipo sostuvo posición sin reactivi dad. Role playing pre-reunión funcionó.",
        gap: "Riesgo mitigado exitosamente con preparación previa.",
      },
      {
        dimension: "Concesiones",
        prepared: "Secuencia: 8% → 10% → 12% (límite)",
        what_happened: "Cerramos en 11% + caso éxito. Cliente pidió condiciones pago después (no anticipado).",
      ...
      },
      {
        ...
        prepared: "Si cliente escala después de límite → bluff. Si baja intensidad → interés real.",
        what_happened: "Cliente bajó intensidad al ofrecer pausa. Confirmó que bluff era táctica, no alternativa real.",
    ...
    <div className="case-demo-container">
      <div className="case-demo-header">
        ...
        <p className="case-demo-subtitle">
          Navegá por las secciones para ver cómo funciona el método en una negociación comercial real.
        </p>
      </div>
      ...
      <div className="case-demo-cta">
        ...
        <p>
          Si enfrentás negociaciones comerciales donde clientes presionan emocionalmente 
          y tu equipo cede por agotamiento, conversemos tu caso.
        </p>
        ...
        <p className="case-demo-cta-note">
          En 90 minutos mapeamos tu poder real, riesgos emocionales y margen de maniobra. 
          Incluye role playing para practicar la conversación difícil.
        </p>
      </div>
    </div>
  );
